                ...
                <div class="card shadow-sm h-100">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-6">S/ {{ number_format($venta->horario->ruta->precio, 2) }}</div>
                        </div>
                        <div class="row mb-3">
            ...
            <div class="card-header bg-warning text-dark">
                ...
                <ul class="mb-0">
                    <li class="mb-2">
                        ...
                        Presentarse en el terminal con anticipación y portar su documento de identidad.
                    </li>
                    <li class="mb-2">
                        <i class="bi bi-box-seam me-2"></i>
                        El equipaje no debe exceder los 20 kg por pasajero. Equipaje adicional puede tener costo extra.
                    </li>
                    <li class="mb-2">
                        <i class="bi bi-shield-lock me-2"></i>
                        No se permite viajar sin identificación o con boletos alterados.
                    </li>
                    <li class="mb-0">
                        <i class="bi bi-arrow-counterclockwise me-2"></i>
                        Cancelaciones deben realizarse hasta 2 horas antes del viaje. Sujeto a penalización según Términos.
                    </li>
                </ul>
            </div>
        </div>
